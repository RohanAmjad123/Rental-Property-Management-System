 ...
 * used to link model to view through the actions and components of the process
...
public class RegisterPropertyController implements Controller, ActionListener {
     ...
     *              information for the backend used to connect to SQL database
     */
     ...
     * e.g to register property, or exit to dash board
     * 
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        // if register property button is pressed
            ...
            try {
                ...
                Property p = new Property(title, description, propertyType, rent, bedrooms, bathrooms, squareFeet,
                ...
                // notify renters of newly registered property
                notifyRenters(model.getRentersWIthSubscriptionsMatching(p));
    ...
    /**
     * Notifies renters of newly registered property
     * 
     * @param emails ArrayList<String> renter emails
     */
    public void notifyRenters(ArrayList<String> emails) {
        // MAIL SERVICE IMPLEMENTATION

        // from email address
        String from = "comapany@mail.com";
        ...
        for (String to : emails) {
            try {
                ...
                message.setSubject("Email from RentSlower, New Property Matching Your Subscription!");

                // set Email text from JTextArea
                message.setText("A new property matching your Subscription on RentSlower was just registered, go check it out!");
